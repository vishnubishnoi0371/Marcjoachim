      ...
      <div className=" container relative mx-auto px-3 md:py-0 py-7">
        ...
        <div className="flex flex-row flex-wrap -mx-3  justify-center">
          {fightData.slice(0, 3).map((data, index) => (
            ...
            >
              <div className=" hover:bg-[#003e924d] hover:bg-[#003E92] duration-300 md:p-[63px_48px] live_card p-[20px_16px] h-full lg:min-h-[230px]">
        ...
        <div className="flex flex-row flex-wrap -mx-3 md:mb-14  pb-10  justify-start ">
          {fightData.slice(3).map((data, index) => (
            <div
              key={index}
              className="md:max-w-[380px] md:px-0 px-3 w-full md:my-0 my-2"
            >
              <div className="live_card hover:bg-[#003e924d] hover:bg-[#003E92] duration-300 md:p-[63px_48px] p-[20px_16px] h-full lg:min-h-[210px]">
                <p className=" font-ff-pop text-base lg:max-w-[280px] font-normal leading-[25.6px] text-black duration-300">
                  {data.para}
                </p>
              </div>
          ...
          <div className=" w-1/3 px-3">
            <div className="border_gradient  w-full max-w-[452px] mt-12 rounded-[8px]">
