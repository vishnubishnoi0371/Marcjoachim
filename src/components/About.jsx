  ...
  return (
    <div id="test" className="relative">
      <div className="  mx-auto max-w-[1140px] px-3 overflow-hidden">
        <div
          data-aos="zoom-in"
          className="pt-10 flex items-center md:justify-start justify-center lg:pt-0"
        >
        ...
        <div className="flex  flex-row flex-wrap mb-14 lg:mb-0  -mx-3  lg:pt-[52px] mt-5">
          ...
          <div className="md:w-1/2 z-30 w-full px-3 lg:ps-[50px]">
            <h1
              data-aos="zoom-in"
              className="fonr-normal text-center md:text-start text-[39px] md:text-[45px] lg:text-[52px] text-black  uppercase font-ff-hel md:leading-[67px]"
            >
              LAWYER <span className="text-[#f77b0b]"> &</span> DIVORCE COACH
            </h1>
            <p
              data-aos="zoom-in"
              className="text-[27px] text-center md:text-start md:text-[37px] font-normal md:leading-[48px] uppercase  font-ff-hel mb-2 lg:mb-[31px] text-black"
            >
            ...
            <p
              data-aos="zoom-in"
              className=" text-xl text-center capitalize md:text-start leading-[28px] font-ff-hel font-normal text-black mb-3"
            >
              About the mindset agency coach
            </p>
            <p
              data-aos="zoom-in"
              className="font-normal text-black text-center mx-auto md:mx-0 md:text-start opacity-[70%] text-base font-ff-pop mb-7 lg:mb-[35px] max-w-[484px]"
            >
            ...
            <div
              data-aos="zoom-in"
              className="border_gradient hover:shadow-button duration-300 cursor-pointer mx-auto   md:mx-0 rounded-full w-full max-w-[350px]"
            >
              <a
                data-aos="zoom-in"
                className="  bg-white p-[13.83px_19px] justify-center rounded-[63px] flex items-center gap-4"
              >
                <span className="font-gradient capitalize text-base font-ff-inter font-medium leading-[24px]">
