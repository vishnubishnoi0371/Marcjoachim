...
const MindsetSwiper = () => {
  return (
    <div className="xl:min-h-[110vh] md:min-h-[55vh] xxl:min-h-[80vh] flex relative">
      <img
      ...
      <div className="container relative md:pt-12 flex-grow flex flex-col mx-auto  px-3">
        <div
          data-aos="zoom-in"
          className="flex items-center justify-center flex-col  xl:absolute z-[11] xxl:top-[2%] lg:top-[4%] xxl:right-[-12%] mt-10 lg:mt-0   ms-[-30px] lg:right-[1%]"
        >
        ...
        <div className="flex relative flex-row  flex-grow mb-6 xl:pt-14 flex-wrap  mt-[14px]  justify-center items-center  -mx-3 ">
          <div className="md:w-6/12 z-30 px-3 w-full">
            <h2
              data-aos="zoom-in"
              className="text-[30px] font-normal text-center md:text-start leading-[38px] text-black uppercase ff-hel"
            >
              THE FOUR PHASES OF
            </h2>
            <h1
              data-aos="zoom-in"
              className="text-[52px] mb-[19px] text-center md:text-start fonr-normal leading-[62px] ff-hel text-black uppercase"
            >
              SEPARATION{" "}
            ...
            <p
              data-aos="zoom-in"
              className="text-base leading-[26px] text-center mx-auto md:mx-0 md:text-start font-ff-pop text-black font-normal opacity-[70%]  mb-[37px] max-w-[484px]"
            >
              ...
              >
                ...
                <SwiperSlide>
                  <div className="my_swipe w-[600px] md:h-[300px] xl:h-[350px] sm:h-[300px] max-w-ful lg:mt-[100px] sm:mt-5 bg-transparent flex flex-col  p-5 md:p-[50px] justify-center items-center">
                    <p className="text-xl leading-[32px] mb-4 font-medium capitalize max-w-[360px] text-center mx-auto font-ff-pop text-white ">
