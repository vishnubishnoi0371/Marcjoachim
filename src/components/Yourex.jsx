...
const Yourex = () => {
  return (
    <div>
      <div className="bg-[url('./Assets/images/webp/ex.png')] z-[1]  relative min-h-[400px] bg-left-bottom md:min-h-[517px] bg-no-repeat bg-100% object-cover flex justify-center items-center ">
