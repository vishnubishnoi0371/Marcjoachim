...
"
            ...
            <p className="text-[45px] md:text-[60px] ff-hel leading-[77px] font-normal max-w-[380px] text-black mb-2">
              Now I let you go!
            </p>
            <p className="text-[16px] font-normal leading-[26px] font-ff-pop mb-[32px] max-w-[500px]">
        ...
        <div className=" mx-auto md:absolute z-[-1] bottom-[-10%] sm:bottom-[-40%] xl:bottom-[-25%]  lg:bottom-[-55%] xl:left-[-2%]">
          ...
          <div className=" flex sm:items-end items-start gap-1">
            ...
            <div className=" flex items-end sm:translate-y-4 -translate-y-3">
              ...
              <p className=" ff-hel  font-normal text-2xl leading-[30px]">
                fault
              </p>
            </div>
          </div>
